...
{
    $("#tableBarang").tablesorter({sortList: [[0, 0], [1, 0]]});
}
);
...
Vel = $ ? $.Velocity : Velocity, function (a) {
        ...
        this.each(function () {
            ...
            function e() {
                ...
                if (j + i.innerWidth() > a(window).width() ? h.alignment = "right" : j - i.innerWidth() + g.innerWidth() < 0 && (h.alignment = "left"), "left" === h.alignment)
                    e = 0, f = h.gutter, c = g.position().left + e + f, i.css({left: c});
                ...
                i.css({position: "absolute", top: g.position().top + b}), i.stop(!0, !0).css("opacity", 0).slideDown({queue: !1, duration: h.inDuration, easing: "easeOutCubic", complete: function () {
                        a(this).css("height", "")
    ...
    a.fn.tooltip = function (b) {
        ...
        return"remove" === b ? (this.each(function () {
            ...
            k.appendTo(j), k.css({top: 0, left: 0}), h.off("mouseenter.tooltip mouseleave.tooltip"), h.on({"mouseenter.tooltip": function (a) {
                    var g = h.data("delay");
